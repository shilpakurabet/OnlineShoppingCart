...
const Header = () => {
      ...
      <>
        <li className="nav-item">
          <Link className="nav-link active" to="/register">
            <i className="fa fa-suitcase"></i> Sell Your Product
          </Link>
        </li>
        <li className="nav-item">
      ...
      <>
        ...
        <li className="nav-item">
          <a className="nav-link">
            ...
            <i className="fa fa-power-off fa-lg text-warning" onClick={logout}>
              {" "}
              Logout{" "}
            </i>
          </a>
  ...
  return (
    <>
      <nav className="navbar navbar-expand-md navbar-dark  bg-success p-3">
        <div className="container-fluid">
          <a className="navbar-brand" href="#">
            <i className="fa fa-shopping-cart fa-lg text-warning"></i> Keep
            Shopping
          </a>
          <button
